...
public class TeacherController extends HttpServlet {
    ...
    //{"description":"id为null的新教师","no":"05","remarks":""}
    //请使用以下JSON测试修改功能
    //{"description":"修改id=1的教师","id":1,"no":"05","remarks":""}

    /**
     * POST, http://172.81.254.198:8080/bysj/teacher.ctl, 增加教师
    ...
    /**
     * DELETE, http://172.81.254.198:8080/bysj/teacher.ctl?id=1, 删除id=1的教师
    ...
    /**
     * PUT, http://172.81.254.198:8080/bysj/teacher.ctl, 修改教师
     *
    ...
    /**
     * GET, http://172.81.254.198:8080/bysj/teacher.ctl?id=1, 查询id=1的教师
     * GET, http://172.81.254.198:8080/bysj/teacher.ctl, 查询所有的教师
     * 把一个或所有教师对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
