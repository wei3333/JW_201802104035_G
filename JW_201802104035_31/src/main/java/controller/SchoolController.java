...
/**
 * 前台url
 * http://172.81.254.198:8080/bysjhtml/myschool/index.html
 */
...
public class SchoolController extends HttpServlet {
    ...
    /**
     * POST, http://172.81.254.198:8080/bysj/school.ctl, 增加学院
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //在数据库表中增加School对象
        try {
            boolean deleted = SchoolService.getInstance().add(schoolToAdd);
            if(deleted){
    ...
    /**
     * DELETE, http://172.81.254.198:8080/bysj/school.ctl?id=1, 删除id=1的学院
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //到数据库表中删除对应的学院
        try {
            boolean updated = SchoolService.getInstance().delete(id);
            if(updated){
    ...
    /**
     * PUT, http://172.81.254.198:8080/bysj/school.ctl, 修改学院
     *
    ...
    /**
     * GET, http://172.81.254.198:8080/bysj/school.ctl?id=1, 查询id=1的学院
     * GET, http://172.81.254.198:8080/bysj/school.ctl, 查询所有的学院
     * 把一个或所有学院对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
